...
try to call it? In this coding challenge letes create an event handler and call it Later let's remove the event handler and observe what happens when we call it.
*/
